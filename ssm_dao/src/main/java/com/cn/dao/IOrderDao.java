...
public interface IOrderDao {
    ...
    @Insert("insert into orders" +
            "(orderNum,orderTime,peopleCount,orderDesc,payType,orderStatus,productId,memberId)" +
            "values(#{orderNum},#{orderTime},#{peopleCount},#{orderDesc},#{payType},#{orderStatus},#{productId},#{memberId})")
    public void save(Orders orders);

    @Update("update orders set orderNum=#{orderNum},peopleCount=#{peopleCount},payType=#{payType},orderDesc=#{orderDesc},orderStatus=#{orderStatus},productId=#{productId},memberId=#{memberId} where id=#{id}")
