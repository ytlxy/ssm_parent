                            ...
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="新建"><i class="fa fa-file-o"
                                                                                                onclick="location.href='${pageContext.request.contextPath}/pages/role-add.jsp'"></i>
                                        新建
                                    </button>
                                    ...
                                    <button type="button" class="btn btn-default" title="刷新"><i class="fa fa-refresh"
                                                                                                onclick="location.href='${pageContext.request.contextPath}/role/findAll.do'"></i>
                                        刷新
                                    </button>
                                </div>
                            </div>
                            ...
                            <c:forEach items="${roleList}" var="role" varStatus="index">
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <button type="button" class="btn bg-olive"
                                                onclick="location.href='${pageContext.request.contextPath}/role/findUserByIdAllPermission.do?id=${role.id}'">
                                            添加权限
                                        </button>
                                        <button type="button" class="btn bg-olive"
                                                onclick="location.href='${pageContext.request.contextPath}/role/deleteRole.do?id=${role.id}'">
                                            删除角色
                                        </button>
                                    </td>
                                </tr>
